...
module VSphereCloud
  describe VmCreator, fake_logger: true do
    ...
    context '#create' do
      ...
      before do
        # TODO(nm): Rewrite these tests to not depend on such agressive mocking; they dont event really
        #   test anything in their current form since it so aggressively uses global mocks...
